...
BUILTIN_THEMES_MANIFEST="$BUILTIN_THEMES_ROOT/manifest.json"
ROTATION_LABEL="com.openai.codex-dream-skin-studio.rotation"
ROTATION_STATE_PATH="$STATE_ROOT/rotation-state.json"
ROTATION_LAUNCH_AGENTS_DIR="${CODEX_DREAM_SKIN_LAUNCH_AGENTS_DIR:-$HOME/Library/LaunchAgents}"
ROTATION_PLIST_PATH="$ROTATION_LAUNCH_AGENTS_DIR/$ROTATION_LABEL.plist"
ROTATION_LOG="$STATE_ROOT/rotation.log"
ROTATION_ERROR_LOG="$STATE_ROOT/rotation-error.log"
